...
<div class="item<?php echo class_exists('PeepSo') ? '' : ' hiddend'; ?>">
    <?php
    $o = new wpdreamsTextSmall("peepso_groups_limit", "Peepso Groups results limit", $sd['peepso_groups_limit']);
    $params[$o->getName()] = $o->getData();
    $o = new wpdreamsTextSmall("peepso_groups_limit_override", " on result page", $sd['peepso_groups_limit_override']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item<?php echo class_exists('PeepSo') ? '' : ' hiddend'; ?>">
    <?php
    $o = new wpdreamsTextSmall("peepso_activities_limit", "Peepso Activities results limit", $sd['peepso_activities_limit']);
    $params[$o->getName()] = $o->getData();
    $o = new wpdreamsTextSmall("peepso_activities_limit_override", " on result page", $sd['peepso_activities_limit_override']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>