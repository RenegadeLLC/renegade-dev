...
<div class="item"><?php
    $o = new wpdreamsGradient("hboxbg", "Result container background color", $sd['hboxbg']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item">
...
<div class="item"><?php
    $o = new wpdreamsGradient("hresultbg", "Result item background color", $sd['hresultbg']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item"><?php
    $o = new wpdreamsGradient("hresulthbg", "Result item mouse hover background color", $sd['hresulthbg']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item">
