...
<div class="item"><?php
    $o = new wpdreamsGradient("settingsbackground", "Settings-icon background color", $sd['settingsbackground']);
    $params[$o->getName()] = $o->getData();
    ?></div>
<div class="item">
    <?php
...
<div class="item"><?php
    $o = new wpdreamsGradient("settingsdropbackground", "Settings drop-down background color", $sd['settingsdropbackground']);
    $params[$o->getName()] = $o->getData();
    ?></div>
<div class="item">
    <?php
