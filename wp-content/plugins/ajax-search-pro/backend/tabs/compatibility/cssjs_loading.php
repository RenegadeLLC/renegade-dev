<fieldset>
    ...
    <div class="item">
        <?php $o = new wpdreamsYesNo("load_lazy_js", "Use the Lazy Loader jQuery script to load the images?",
            $com_options['load_lazy_js']
        ); ?>
        <p class='descMsg'>Will load an use a modified version of <a href="http://jquery.eisbehr.de/lazy/" target="_blank">Lazy Load</a> script to load the images of results.</p>
    </div>
    <div class="item">
