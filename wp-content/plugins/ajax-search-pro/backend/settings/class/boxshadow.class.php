        ...
        function getType() {
            ...
            <div class='wpdreamsBoxShadow'>
                <fieldset>
                    ...
                    <div class="item-flex">
                        <div>
                            <label>Style<select class='smaller _xx_inset_xx_'>
                        ...
                        <fieldset class="wpd_shadow_size">
                            <legend>Shadow size</legend>
                            <label>Horizontal offset<input type='text' class='twodigit _xx_hlength_xx_'value="<?php echo $this->hlength; ?>" />px</label>
                            <label>Vertical offset<input type='text' class='twodigit _xx_vlength_xx_' value="<?php echo $this->vlength; ?>" />px</label><br>
                            <label>Blur radius<input type='text' class='twodigit _xx_blurradius_xx_' value="<?php echo $this->blurradius; ?>" />px</label>
                            <label>Spread<input type='text' class='twodigit _xx_spread_xx_' value="<?php echo $this->spread; ?>" />px</label>
                        </fieldset>
                    </div>
                </fieldset>
